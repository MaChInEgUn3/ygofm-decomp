...
s32 func_80058B4C(u8 *arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4, s32 arg5, s32 arg6, s32 arg7);
...
void func_80023144(u8 *arg0, s32 arg1)
{
  ...
  if ((arg0[0x17] == 2) && (arg0[0x18] != 0))
  {
    ...
    if (c != 0)
    {
      if (((u32) c) >= 4U)
      {
        if (D_800E9FF0[D_8009B1D5 ^ 1].unk19)
        {
          D_801D5608[2] = 3;
        }
        else
  ...
  p = *((u8 **) arg0);
  o = func_80035BE4(arg0[0x14], mode, (*((s16 *) (p + 0x30))) + 0x10, (*((s16 *) (p + 0x32))) + (*((s8 *) (arg0 + 0x16))), 0x120, 0x40);
