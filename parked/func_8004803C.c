...
void func_8004803C(s16 arg0, s32 arg1, s32 arg2, s32 arg3, s32 arg4, u8 arg5,
    ...
    if ((idx & 0xFFFF) != 0xFFFF) {
        ...
        *(s32 *)(b + 0x3A0) = *(u16 *)(n + *(s32 *)(b + 0x444) + 6) * 8 * 2;
        ...
        *(s16 *)(D_8009B45C + arg1 * 2 + 0x404) = arg0;
        *(u16 *)(D_8009B45C + arg1 * 2 + 0x414) = *(u16 *)(D_8009B45C + 0x38C);
        *(u16 *)(D_8009B45C + arg1 * 2 + 0x41C) = *(u16 *)(D_8009B45C + 0x38E);
        (D_8009B45C + arg1)[0x424] = 0xFF;
        (D_8009B45C + arg1)[0x428] = 0;

        *(s16 *)(D_8009B45C + arg1 * 2 + 0x42C) =
            *(u8 *)(n + *(s32 *)(D_8009B45C + 0x444) + 1) * 4;
