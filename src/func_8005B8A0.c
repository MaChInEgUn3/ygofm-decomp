#define D_800FE0CC_SIZED8
#define D_80010000_SIZED
#define D_800FE0D0_SIZED8
#define D_8009B142_SIZED8
#define D_8009B143_SIZED8
#define D_8009B144_SIZED8
#include "common.h"
...
s32 func_8005B8A0(u8 *src, s32 a1, s32 a2, s32 a3, s32 a4, s32 a5) {
    ...
    D_8009B070 = a3;
    D_8009B060 = a4;
    D_8009B498 = D_80010000[0];
    D_8009B061 = a5;
    if (D_8009B060 != 0) {
        m = func_80085320(D_80010000[0], a5);
        rect[0] = m * 0x140;
        rect[1] = 0;
        rect[2] = D_800FE0D0[0];
        rect[3] = D_800FE0D4[0];
